...
| `BirdLife-BirdTree crosswalk.csv` | Species-name crosswalk linking BirdLife (`Species1`) and BirdTree (`Species3`) taxonomies. Used to reconcile species names between the IUCN assessments and the phylogeny. Included with AVONET. https://figshare.com/s/b990722d72a26b5bfead |
